    ...
    CommandLineRunner initDatabase(
        ...
        return args -> {
            try {
                ...
                } else if(productoRepository.findAll().isEmpty()){
                    System.out.println("Creando registros de productos...");
                    Producto producto1 = new Producto("Laptop Dell XPS 13", "Laptop Dell XPS 13", 1200.00, 1L);
                    Producto producto2 = new Producto("Smartphone Samsung Galaxy S21", "Smartphone Samsung Galaxy S21", 800.00, 1L);
                    Producto producto3 = new Producto("Cafetera Philips", "Cafetera Philips para espresso", 150.00, 2L);
                    Producto producto4 = new Producto("Aspiradora Robot", "Aspiradora robot inteligente", 300.00, 2L);
